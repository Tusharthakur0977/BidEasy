  ...
  return (
    <div className='flex-grow-0 ml-10 text-sm w-full font-medium leading-6 text-gray-900 shadow-xl'>
      ...
      <div className='flex py-9 px-20 '>
        <label
          htmlFor='timezone'
          className='flex-grow ml-5 pt-2 w-10 font-semibold text-xl text-gray-700 text-nowrap  mb-2'
        >
          Time Zone :{' '}
        </label>
        <select
          id='timezone'
          name='timezone'
          className='flex-grow-0 w-full p-4 ml-20 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 '
        >
      ...
      <div className='flex py-2 px-20   '>
        <label
          htmlFor='timezone'
          className='flex-grow  pt-2 ml-4 w-10 font-semibold text-xl text-gray-700 text-nowrap '
        >
          Event Date :{' '}
        </label>
        <input
      ...
      <div className=' flex py-4 px-96 ml-56'>
        <button
          className='flex  right-0  mb-4 mr-4 py-3 px-10 bg-blue-500 text-white rounded-md'
        ...
        <button
          className='flex right-0  mb-5 mr-24  py-3 px-10  bg-blue-500 text-white rounded-md'
          onClick={handleClick}
        >
          Save
        </button>
